...
const TemperatureAndDetails = ({weather:{
    details,icon,temp,temp_min,temp_max,sunrise,sunset,humidity,speed,feels_like,timezone
}}) => {
    return (
        <div>
            ...
            <div className='flex flex-row items-center justify-between text-white py-3'>
                ...
                <div className='flex flex-col space-y-2'>
                    <div className='flex font-light text-sm items-center justify-center'>
                        ...
                        Real Feel: <span className='font-md ml-1'>{`${feels_like.toFixed()}°`}</span>
                    </div>
                    <div className='flex font-light text-sm items-center justify-center'>
                        <UilTear size={18} className='mr-1' />
                        Humidity: <span className='font-md ml-1'>{`${humidity.toFixed()}%`}</span>
                    </div>
                    <div className='flex font-light text-sm items-center justify-center'>
                        <UilWind size={18} className='mr-1' />
                      Wind: <span className='font-md ml-1'>{`${speed.toFixed()}km/hr`}</span>
                    </div>
                </div>
            </div>
